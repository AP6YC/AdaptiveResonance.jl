...
@testset "Vigilance, search, labels, and statistics" begin
    ...
    for sort in (false, true)
        ...
        # At rho=0 a zero-activation category must still be considered after
        # another zero-activation category fails vigilance.
        ...
        search.T = [0.0, 0.0]
        search.M = [-0.1, 0.0]
        @test HART.hypersphere_search(search) == 2
